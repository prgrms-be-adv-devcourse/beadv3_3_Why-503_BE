...
public interface ShowCalculator {
    ...
    Map<String, Double> genreScores(ResultRequest request, Map<ShowCategory, Double> categoryScores);
    double finalScore(Performance performance, Map<ShowCategory, Double> categoryScores, Map<String, Double> genreScores);
