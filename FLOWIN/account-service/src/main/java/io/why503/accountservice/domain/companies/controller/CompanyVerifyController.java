...
import io.why503.accountservice.domain.companies.model.dto.requset.CompanyVerifyRequest;
import io.why503.accountservice.domain.companies.model.dto.response.CompanyVerifyResponse;
import io.why503.accountservice.domain.companies.service.impl.CompanyVerifyServiceImpl;
...
public class CompanyVerifyController {
    ...
    private final CompanyVerifyServiceImpl verifyService; // 이메일 인증 코드 검증 비즈니스 로직 처리 Service
