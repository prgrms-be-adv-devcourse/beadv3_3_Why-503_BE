 ...
 * - API 응답 구조 통일 목적
 */
package io.why503.performanceservice.domain.concerthall.model.dto.response;
...
public record ConcertHallResponse(
        ...
        @NotBlank ConcertHallStatus concertHallStatus,  //공연장 상태
        @NotNull Integer concertHallSeatScale,          //총 좌석 수
        @NotBlank String concertHallStructure,          //공연장 구조
        @NotNull BigDecimal concertHallLatitude,        //위도
        @NotNull BigDecimal concertHallLongitude        //경도
) { }
