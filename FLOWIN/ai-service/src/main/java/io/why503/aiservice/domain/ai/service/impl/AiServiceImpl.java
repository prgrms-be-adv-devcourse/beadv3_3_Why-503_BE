...
public class AiServiceImpl implements AiService {
    ...
    private final AiPromptImpl aiPrompt;
        ...
        try {
            return CompletableFuture.supplyAsync(() -> {
                ...
                AiResponse fixedResponse = aiResponseMapper.AiResponseToFixedResponse(
                        aiResponse, categoryScore, genreScore, topShowCategorys, topGenres, topFinalShows
                );

                //AiRecommendation -> 스트림, Recommendations -> 스트림
                List<Recommendations> finalRecommendations =
                        recommendationsMapper.RecommendationsToAiRecommendations(
